public class Studente extends Persona implements Certificato {
    ...
    //per generare matricola univoca
    public int numeroProgressivo = 0;
    public String matricola;

    //costruttore personalizzato
    public Studente(String nome, String cognome, int annoDiNascita, int classe, char sezione, int annoRilascio, String cognomeMedico) {
    ...
    public Studente() {} // rigenero il costruttore predefinito qualora il main() non usi quello personalizzato
    ...
    public String generaMatricola() {
        ...
        numeroProgressivo = Scuola.getStudenti().size();
